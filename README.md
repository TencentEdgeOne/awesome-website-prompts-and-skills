...
| 名称 | 类型 | 技术栈 | 出品方 |
|---|---|---|---|
| [Maison Perle](./prompts/luxury-jewelry-ecommerce-website.md) | 奢侈品珠宝电商单页站 | React + Vite + TS + Tailwind + shadcn/ui + Edge Functions | EdgeOne 团队 |
| [Pawsome](./prompts/pawsome.md) | 宠物社区落地页 | React + Vite + TS + Tailwind + shadcn/ui + Edge Functions + KV | EdgeOne 团队 |
| [Luxury Perfume](./prompts/luxury-perfume.md) | 高奢香水电商落地页 | React + Vite + TS + Tailwind + shadcn/ui | EdgeOne 团队 |
| [Lumina Walls](./prompts/lumina-walls.md) | AI 壁纸生成器落地页 | React + Vite + TS + Tailwind + shadcn/ui + Edge Functions | EdgeOne 团队 |
| [Start Somewhere](./prompts/start-somewhere.md) | 电影感旅行目录站 | React + Vite + Tailwind + Framer Motion + Edge Functions | EdgeOne 团队 |
| [DramaAI](./prompts/drama-ai.md) | AI 短剧剧本生成器落地页 | React + Vite + TS + Tailwind + Edge Functions | EdgeOne 团队 |
